...
Table_data <- read_excel("Projet P1 SENEGAL - Sympathôtes/Redaction/Tableau_prelim/Table_data.xlsx") 
...
```{r, message=FALSE}
read_csv("Projet P1 SENEGAL - Sympathôtes/Doc_projet/Projet_V2/stats_run_SENEGAL.csv")
```
...
```{r, message=FALSE}
count_otu_Cx <- read_csv("Projet P1 SENEGAL - Sympathôtes/Doc_projet/Projet_V2/Projet_V3_fichiers_filtrer/culex/otu_clean_fil10.csv")
...
![Figure : Classification taxonomique ICTV](Projet P1 SENEGAL - Sympathôtes/Doc_projet/Projet_V2/Photos_results/Classification_ICTV.png)
...
```{r, message=FALSE}
taxo_table_Cx <- read_excel("Projet P1 SENEGAL - Sympathôtes/Doc_projet/Projet_V2/Projet_V3_fichiers_filtrer/culex/taxo_table_Cx_propre.xlsx")
...
samples_df_Cx <- read_excel("D:/Mes Donnees/Thèse CIRAD/Projet P1 SENEGAL - Sympathôtes/Supp_data (metadata, description, ...)/metadata_PTQ.xlsx", sheet = "Feuil1")
...
![Figure : Représentation schématique de la diversité alpha et beta](Projet P1 SENEGAL - Sympathôtes/Doc_projet/Projet_V2/Photos_results/Alpha_Beta_diversity.png)
...
dist_matrixes_Jac_Bray_OTU <- read_excel("Projet P1 SENEGAL - Sympathôtes/Doc_projet/Projet_V2/Jaccard_vs_Bray/dist_matrixes_Jac_Bray_OTU_v3.xlsx") # in reports folder
...
dist_Jac_Bray2 <- read_excel("Projet P1 SENEGAL - Sympathôtes/Doc_projet/Projet_V2/Jaccard_vs_Bray/dist_matrixes_Jac_Bray_OTU_v3_modif_for_protocole.xlsx") # in reports folder
...
### 2.6.2 : Betadisperser pour tester l'homogénéité des dispersions multivariées
...
### 2.6.3 : Créer une cartographie des points d'échantillonnages des données
...
```{r}
SupData_merge <- read_excel("Projet P1 SENEGAL - Sympathôtes/Supp_data (metadata, description, ...)/SupData_merge_1.xlsx")
SupData_merge
```
